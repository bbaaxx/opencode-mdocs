...
### architecture
- **mdocs Tool Gate Exemptions** — `architecture/mdocs-tool-gates.md`
- **Original Plugin Design Spec (Pre-Dogfooding Blueprint)** — `architecture/plugin-design-spec.md`
- **Original Implementation Plan (Pre-Dogfooding Blueprint)** — `architecture/implementation-plan.md`
