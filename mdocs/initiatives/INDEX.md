...
- **Upgrade Dispatch into Memory Retrieval Assembly** (active) — 2026-05-28 — [phase-1, dispatch, memory, retrieval, subagent]
- **Add Resume and Status Cockpit** (active) — 2026-05-28 — [phase-1, resume, status, ux, workflow]
- **Define v2 Initiative and Wiki Memory Metadata** (active) — 2026-05-28 — [phase-1, schema, metadata, memory-model, wiki]
- **Add Cross-Link Graph Linter Rules** (active) — 2026-05-28 — [phase-1, linter, graph, links, quality]
- **Align Implementation with Philosophy** (active) — 2026-05-28 — [roadmap, philosophy, architecture, ux, memory]
